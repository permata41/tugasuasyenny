...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'beautybestie_backup_069bca3e85896c862909_20221221135816_archive.zip';
        const ARCHIVE_SIZE       = '90253869';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '069bca3-21135816';
        const SECONDARY_PACKAGE_HASH = '69c4223-21135816';
        const VERSION            = '1.5.1';
